...
namespace App_plateforme_de_recurtement.Controllers
{
    ...
    public class FormController : ControllerBase
    {
        ...
        public FormController(FormService formService, ApplicationDbContext context, ILogger<FormController> logger, EmailService emailService, IConfiguration configuration, FormRepository formRepository)
        {
        ...
        private string GenerateTestLink(string subject)
        {
            var url = Url.Action("testdetails", "Home", new { subject = subject }, Request.Scheme);
            return url;
        }
